...
Σε αυτή τη δραστηριότητα, θα μάθετε πώς να κάνετε ένα παιχνίδι αγώνων. Ο παίκτης χρησιμοποιεί το ποντίκι για να πλοηγήσει μία βάρκα σε ένα έρημο νησί χωρίς να χτυπήσει τα εμπόδια.
